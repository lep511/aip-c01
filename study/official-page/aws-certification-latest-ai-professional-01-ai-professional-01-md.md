...
**Topics**
+ [Introduction](#ai-professional-01-intro)
+ [Target candidate description](#ai-professional-01-target)
+ [Exam content](#ai-professional-01-exam-content)
+ [Content outline](#ai-professional-01-domains)
+ [Content Domain 1: Foundation Model Integration, Data Management, and Compliance](ai-professional-01-domain1.md)
+ [Content Domain 2: Implementation and Integration](ai-professional-01-domain2.md)
+ [Content Domain 3: AI Safety, Security, and Governance](ai-professional-01-domain3.md)
+ [Content Domain 4: Operational Efficiency and Optimization for GenAI Applications](ai-professional-01-domain4.md)
+ [Content Domain 5: Testing, Validation, and Troubleshooting](ai-professional-01-domain5.md)
+ [Technologies and concepts that might appear on the exam](ai-professional-01-technologies-concepts.md)
+ [Mentions of AWS services on the exam](ai-professional-01-service-mentions.md)
+ [In-Scope AWS Services](aip-01-in-scope-services.md)
+ [Out-of-Scope AWS Services](aip-01-out-of-scope-services.md)
+ [Survey](#ai-professional-01-survey)

## Introduction
<a name="ai-professional-01-intro"></a>

The [AWS Certified Generative AI Developer - Professional (AIP-C01)](https://aws.amazon.com/certification/certified-generative-ai-developer-professional/) exam is intended for individuals who perform a GenAI developer role. The exam validates a candidate's ability to effectively integrate foundation models (FMs) into applications and business workflows. This certification demonstrates practical knowledge of how to implement GenAI solutions into production environments by using AWS technologies.
...
<a name="ai-professional-01-target"></a>
...
<a name="ai-professional-01-aws-knowledge"></a>
...
<a name="ai-professional-01-out-of-scope"></a>
...
## Exam content
<a name="ai-professional-01-exam-content"></a>

### Question types
<a name="ai-professional-01-question-types"></a>
...
### Unscored content
<a name="ai-professional-01-unscored-content"></a>
...
### Exam results
<a name="ai-professional-01-exam-results"></a>
...
## Content outline
<a name="ai-professional-01-domains"></a>
...
+ [Content Domain 1: Foundation Model Integration, Data Management, and Compliance (31% of scored content)](ai-professional-01-domain1.md)
+ [Content Domain 2: Implementation and Integration (26% of scored content)](ai-professional-01-domain2.md)
+ [Content Domain 3: AI Safety, Security, and Governance (20% of scored content)](ai-professional-01-domain3.md)
+ [Content Domain 4: Operational Efficiency and Optimization for GenAI Applications (12% of scored content)](ai-professional-01-domain4.md)
+ [Content Domain 5: Testing, Validation, and Troubleshooting (11% of scored content)](ai-professional-01-domain5.md)

## Survey
<a name="ai-professional-01-survey"></a>

How useful was this exam guide? Let us know by [taking our survey](https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=AI-Pro&course_id=AIP-C01&Q_Language=EN).
